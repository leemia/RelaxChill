    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div style ="text-align:left">  
                    <a href="Admin/Insert" class="btn btn-warning">Add Music</a>
                </div>
        ...
        <div>
            ...
            if(isset($data["allmusic"])){
                ...
                {
                    if ($currentPage > 1){
                        echo '<a class = "button" style="margin:0 5px;text-decoration:none;" href = "Admin/MusicManage/'.$musicPerPage.'/'.($currentPage-1).'">Previous</a>'; 
                    }
                    for($i=1; $i<=$totalPages; $i++){
                        if ($i == $currentPage){
                            ...
                            echo '<a  class = "button" style="margin:0 5px;text-decoration:none;" href = "Admin/MusicManage/'.$musicPerPage.'/'.$i.'">'.$i .'</a>'; 
                        }
                    }
                    // nếu current_page < $total_page và total_page > 1 mới hiển thị nút next
                    if ($currentPage < $totalPages){
                        echo '<a class = "button" style="margin:0 5px;text-decoration:none;" href = "Admin/MusicManage/'.$musicPerPage.'/'.($currentPage+1).'">Next</a>'; 
                    }
                }
